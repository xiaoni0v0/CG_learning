import numpy as np
from halfedge import TriangleMesh, Vertex, load_obj, save_obj
...
def main():
    ...
    for i in range(2):
        ...
        print(f"After subdivision {i+1}: {len(mesh.vertices)} vertices, {len(subdivided_faces)} faces")
